...
#Часто при разработке и работе с рассылками писем(e-mail) они отправляются от одного и
# того же пользователя(администрации или службы поддержки).
...
#Если же sender и recipient совпадают, то ьзя отправить письмо самому себевывести "Нел!"
